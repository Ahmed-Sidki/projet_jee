<%-- 
    Document   : ListingMarque
    Created on : 7 juin 2022, 00:33:16
    Author     : asus-pc
--%>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <form class="form-header" action="http://localhost:8080/GestionduStock-war/CreationMarque" method="GET">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>ajouter marque
                                        </button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="  user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>table des marques</h3>
                                    ...
                                    <div class=" table-responsive table-data">
                                        <table class="table">
                                            <thead>
                                                <tr>                                                 
                                                    <td>nom marque</td>
                                                    <td>origine marque </td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <% 
                                                 List<Marque> ListMarques = (List<Marque>) request.getAttribute("ListMarques");
                                                    for (int i = 0; i < ListMarques.size(); i++){
                                                 %>
                                                <tr> 
                                                   <td>
                                                        <span><%=ListMarques.get(i).getNomMarque() %></span>
                                                    </td>
                                                    <td>
                                                        <span ><%= ListMarques.get(i).getOrigineFabrication() %></span>
                                                    </td>        
                                                    <td>
